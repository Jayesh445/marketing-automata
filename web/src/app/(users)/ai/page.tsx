  ...
  >([
    {
      ...
      type: "caption",
      content:
        "🚀 Exciting news! Our new AI-powered marketing platform is here to revolutionize your campaigns. Get ready to boost your ROI by 300%! #MarketingAI #Innovation",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-sm text-blue-700">
                      Include details about your product, target audience, and
                      key benefits
                    </p>
                  </div>
