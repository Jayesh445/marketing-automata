...
const integrations = [
  {
    ...
    name: "LinkedIn",
    description:
      "Connect your LinkedIn account for professional networking campaigns",
    icon: "💼",
  ...
  },
  {
    ...
    name: "Shopify",
    description:
      "Connect your e-commerce store for customer data and sales tracking",
    icon: "🛒",
    category: "E-commerce",
    status: "available",
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge
                      className={
                        complexityColors[
                          integration.setupComplexity as keyof typeof complexityColors
                        ]
                      }
                    >
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mb-3">
                  We only access the data necessary for your marketing campaigns
                  and analytics.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
