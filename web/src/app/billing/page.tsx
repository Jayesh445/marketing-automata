                    ...
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span
                        className={getUsageColor(
                          getUsagePercentage(
                            currentPlan.usage.contacts.used,
                            currentPlan.usage.contacts.limit
                          )
                        )}
                      >
                        {currentPlan.usage.contacts.used.toLocaleString()} /{" "}
                        {currentPlan.usage.contacts.limit.toLocaleString()}
                      </span>
                    </div>
                    <Progress
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span
                        className={getUsageColor(
                          getUsagePercentage(
                            currentPlan.usage.emails.used,
                            currentPlan.usage.emails.limit
                          )
                        )}
                      >
                        {currentPlan.usage.emails.used.toLocaleString()} /{" "}
                        {currentPlan.usage.emails.limit.toLocaleString()}
                      </span>
                    </div>
                    <Progress
                      value={getUsagePercentage(
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span
                        className={getUsageColor(
                          getUsagePercentage(
                            currentPlan.usage.aiGenerations.used,
                            currentPlan.usage.aiGenerations.limit
                          )
                        )}
                      >
                        {currentPlan.usage.aiGenerations.used} /{" "}
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="text-success">
                        {currentPlan.usage.campaigns.used} /{" "}
                        {currentPlan.usage.campaigns.limit}
                      </span>
                    </div>
                  </div>
                </div>
