        ...
        <div className="text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your marketing strategy with intelligent automation, real-time analytics, 
              and multi-platform campaign management. Boost your ROI by up to 300%.
            </p>
          </motion.div>
          ...
          >
            <Link href="/signup">
              <Button size="lg" className="bg-primary hover:bg-primary-hover text-white px-8 py-3">
                Start Free Trial
            ...
            <div className="bg-linear-to-r from-primary to-primary-hover rounded-lg p-8 shadow-2xl">
              <div className="bg-white rounded-lg p-6 shadow-lg">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <div className="metric-card">
                    <div className="text-2xl font-bold text-secondary">$12.4K</div>
