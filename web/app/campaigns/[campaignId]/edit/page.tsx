...
const platforms = [
  { id: 'email', name: 'Email', icon: '📧', description: 'Email marketing campaigns' },
  { id: 'linkedin', name: 'LinkedIn', icon: '💼', description: 'Professional networking' },
  { id: 'twitter', name: 'Twitter', icon: '🐦', description: 'Social media engagement' },
  { id: 'instagram', name: 'Instagram', icon: '📸', description: 'Visual content sharing' },
  { id: 'youtube', name: 'YouTube', icon: '📺', description: 'Video content promotion' },
  { id: 'whatsapp', name: 'WhatsApp', icon: '💬', description: 'Direct messaging' },
  { id: 'reddit', name: 'Reddit', icon: '🔴', description: 'Community engagement' },
];
...
export default function EditCampaignPage({ params }: { params: { campaignId: string } }) {
  const [campaignData, setCampaignData] = useState({
    ...
    content: {
      ...
      message: 'Get ready for summer with our biggest sale of the year! Enjoy up to 50% off on all products. Limited time offer - shop now before it\'s too late!',
      cta: 'Shop Now',
    },
    schedule: {
      type: 'scheduled',
  ...
  const handleDelete = () => {
    ...
    console.log('Deleting campaign:', params.campaignId);
  };
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Select 
                ...
                onValueChange={(value) => setCampaignData(prev => ({ ...prev, status: value }))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
