...
export default function CampaignDetailPage({
  ...
  useEffect(() => {
    if (isConnected) {
      ...
      subscribe(`/topic/campaign/${params.campaignId}`, (data) => {
        setMetrics((prev) => ({ ...prev, ...data }));
      });

      subscribe(`/topic/campaign/${params.campaignId}/realtime`, (data) => {
      ...
      return () => {
        ...
        unsubscribe(`/topic/campaign/${params.campaignId}`);
        unsubscribe(`/topic/campaign/${params.campaignId}/realtime`);
      };
    }
  }, [isConnected, subscribe, unsubscribe, params.campaignId]);
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Link href={`/campaigns/${params.campaignId}/edit`}>
              <Button variant="outline">
