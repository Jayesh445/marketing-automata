...
const plans = [
  {
    ...
    price: '$29',
    period: '/month',
    description: 'Perfect for small teams getting started with marketing automation',
    features: [
      'Up to 5 campaigns',
      '1,000 contacts',
      ...
      <section className="py-20 bg-linear-to-r from-primary to-primary-hover">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Join thousands of marketers who have already revolutionized their campaigns
          </p>
          <Link href="/signup">
